...
class EmbeddingLayer(nn.Module):
    def __init__(self, embed_size):
        ...
        # 2*embed_sizeからembed_sizeに射影する線形層
        self.location_proj = nn.Linear(2 * embed_size, embed_size)
    ...
    def forward(self, day, time, location_x, location_y, timedelta):
        ...
        # location_xとlocation_yをconcatして射影
        location_concat = torch.cat([location_x_embed, location_y_embed], dim=-1)
        location_embed = self.location_proj(location_concat)
