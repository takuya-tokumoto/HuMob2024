...
class HuMobDatasetTaskATrain(Dataset):
    def __init__(self, path, use_sampling):
        ...
        for uid, traj in tqdm(self.df.groupby("uid")):
            ...
            input = (input_x - 1) * 200 + (input_y - 1) + 1
            ...
            label = (label_x - 1) * 200 + (label_y - 1) + 1
            ...
            self.label_array.append(label - 1)
    ...
    def __getitem__(self, index):
        ...
        input = torch.tensor(self.input_array[index])
        ...
        label = torch.tensor(self.label_array[index])
